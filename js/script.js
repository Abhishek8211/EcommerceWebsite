...
const products = [
  // Electronics
  {
    ...
    description:
      "Experience superior sound quality with these premium wireless headphones featuring noise cancellation, 30-hour battery life, and comfortable over-ear design. Perfect for music lovers and professionals.",
  },
  {
    id: "prod2",
    ...
    description:
      "Advanced smartwatch with fitness tracking, heart rate monitor, GPS, and water resistance. Stay connected and healthy with this cutting-edge wearable technology.",
  },
  {
    id: "prod3",
    ...
    description:
      "High-precision wireless gaming mouse with customizable RGB lighting, 16000 DPI sensor, and ergonomic design for extended gaming sessions.",
  },
  {
    id: "prod4",
    ...
    description:
      "Portable Bluetooth speaker with 360-degree sound, waterproof design, and 20-hour battery life. Perfect for outdoor adventures and parties.",
  },
  ...
  // Fashion
  {
    ...
    description:
      "Comfortable and stylish casual sneakers perfect for everyday wear. Features breathable mesh upper and cushioned sole for all-day comfort.",
  },
  {
    id: "prod6",
    ...
    description:
      "Genuine leather wallet with RFID protection, multiple card slots, and slim design. Combines style with security and functionality.",
  },
  {
    id: "prod7",
    ...
    description:
      "Polarized designer sunglasses with UV protection and durable frame. Make a style statement while protecting your eyes.",
  },
  {
    id: "prod8",
    ...
    description:
      "Spacious and durable backpack with laptop compartment, water-resistant material, and ergonomic design for daily commute.",
  },
  ...
  // Home & Kitchen
  {
    ...
    description:
      "Automatic coffee maker with programmable settings, thermal carafe, and brewing strength control. Start your day with the perfect cup of coffee.",
  },
  {
    id: "prod10",
    ...
    description:
      "Complete cookware set with non-stick coating, heat-resistant handles, and dishwasher-safe design. Essential for every kitchen.",
  },
  ...
  // Books
  {
    ...
    description:
      "A dazzling novel about all the choices that go into a life well lived. Somewhere out beyond the edge of the universe there is a library.",
  },
  {
    id: "prod12",
    name: "Atomic Habits",
    ...
    description:
      "An Easy & Proven Way to Build Good Habits & Break Bad Ones. Transform your life one tiny change at a time.",
  },
  ...
  // Sports
  {
    ...
    description:
      "Extra thick yoga mat with non-slip surface, eco-friendly material, and carrying strap. Perfect for yoga, pilates, and home workouts.",
  },
  {
    id: "prod14",
    ...
    description:
      "Set of 5 resistance bands with different strength levels, door anchor, and carrying bag. Ideal for strength training and flexibility.",
  },
  ...
  // Additional products for variety
  {
    ...
    description:
      "Mechanical gaming keyboard with RGB backlighting, tactile switches, and programmable keys for ultimate gaming experience.",
  },
  {
    id: "prod16",
    ...
    description:
      "Multi-port USB-C hub with HDMI, USB 3.0, SD card reader, and power delivery. Expand your laptop connectivity.",
  },
  {
    id: "prod17",
    ...
    description:
      "Advanced fitness tracker with heart rate monitor, sleep tracking, step counter, and smartphone notifications.",
  },
  {
    id: "prod18",
    ...
    description:
      "Stainless steel insulated water bottle that keeps drinks cold for 24 hours or hot for 12 hours. Leak-proof and eco-friendly.",
  },
  ...
  // Smartphones
  {
    ...
    description:
      "Latest flagship iPhone with A17 Pro chip, titanium design, 48MP camera system, and USB-C. Experience unmatched performance and photography.",
  },
  {
    id: "prod20",
    ...
    description:
      'Premium Android flagship with S Pen, 200MP camera, AI features, and stunning 6.8" Dynamic AMOLED display. Power meets elegance.',
  },
  {
    id: "prod21",
    ...
    description:
      "Best Android camera phone with Google Tensor G3 chip, AI-powered features, and pure Android experience. Photography perfection.",
  },
  {
    id: "prod22",
    name: "OnePlus 12",
    ...
    description:
      "Flagship killer with Snapdragon 8 Gen 3, 100W fast charging, Hasselblad camera, and 120Hz AMOLED display. Speed redefined.",
  },
  {
    id: "prod23",
    name: "Xiaomi 14 Pro",
    ...
    description:
      "Premium flagship with Leica optics, Snapdragon 8 Gen 3, 120W HyperCharge, and stunning design. Photography excellence.",
  },
  {
    id: "prod24",
    ...
    reviews: 1560,
    image:
      "https://images.unsplash.com/photo-1592286927505-b0501739c2fb?w=500&h=500&fit=crop",
    description:
      "Unique transparent design with Glyph Interface, Snapdragon 8+ Gen 1, and premium build. Stand out from the crowd.",
  },
];
...
function createProductCard(product) {
  ...
  if (product.discount >= 50)
    badges.push('<span class="badge badge-hot">🔥 Hot Deal</span>');
...
function filterByCategory(subcategory) {
  ...
  showToast(
    `📱 Showing ${filteredProducts.length} ${displayName} products`,
    "success",
  );
}
...
function toggleWishlist(productId) {
  ...
  if (wishlistSection) {
    const wishlistProductsToShow = wishlist
      .map((id) => getProductById(id))
      .filter(Boolean);
    if (wishlistProductsToShow.length === 0) {
      ...
      wishlistSection.innerHTML = wishlistProductsToShow
        .map((p) => createProductCard(p))
        .join("");
    }
  }
...
function flyToCart(productElement) {
  ...
  flyingProduct.style.setProperty(
    "--x",
...
const dummyNotifications = [
  {
    ...
    message:
      "Your order #12345 has been placed successfully and is being processed. You will receive updates on your email.",
    time: "2 minutes ago",
    read: false,
  },
  {
    ...
    message:
      "We detected a new login to your account from Chrome on Windows. If this wasn't you, please secure your account immediately.",
    time: "1 hour ago",
    read: false,
  },
  {
    ...
    message:
      "Limited time offer! Get up to 70% off on electronics, fashion, and home appliances. Hurry, sale ends in 6 hours!",
    time: "3 hours ago",
    read: false,
  },
  {
    ...
    message:
      "We have successfully received your payment of $299.99 for order #12340. Your order is now confirmed.",
    time: "5 hours ago",
    read: true,
  },
  {
    ...
    message:
      "Great news! Your order #12338 has been shipped and is on its way. Expected delivery: Tomorrow by 6 PM.",
    time: "1 day ago",
    read: true,
  },
  {
    ...
    message:
      "As a valued customer, enjoy an extra 20% off on your next purchase. Use code SPECIAL20 at checkout.",
    time: "2 days ago",
    read: true,
  },
  {
    ...
    message:
      "Your order #12335 has been delivered successfully. We hope you love your purchase! Please rate your experience.",
    time: "3 days ago",
    read: true,
  },
  {
    ...
    message:
      "Your password was changed successfully. If you didn't make this change, contact our support team immediately.",
    time: "5 days ago",
    read: true,
  },
];
...
let notifications =
  JSON.parse(localStorage.getItem("notifications")) || dummyNotifications;
...
function simulateNewNotification() {
  const notifications = [
    ...
    },
    {
      ...
      title: "Special Offer",
      message:
        "Limited time! Get 25% off on selected items. Use code SAVE25 at checkout.",
    },
    {
      type: "delivery",
      icon: "🚚",
...
async function loadProductsFromBackend() {
  try {
    ...
    // Replace hardcoded products with backend data
    ...
    // Fallback: use hardcoded products if backend fails
    console.log('⚠️ Using hardcoded products as fallback');
  }
}
...
async function syncCartWithBackend() {
  ...
  try {
    ...
    // Update localStorage cart from backend
...
async function loadNotificationsFromBackend() {
  ...
  try {
    const { notifications: backendNotifications, unreadCount } = await getNotifications();
    ...
    backendNotifications.forEach(n => {
      addNotification(n.type, n.icon, n.title, n.message, n.read);
    });
...
function updateUIForLoggedInUser() {
  ...
  if (profileDropdown) {
    ...
    if (!profileDropdown.querySelector('.logout-item')) {
...
// Override addToCart to use backend
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (document.getElementById('topDeals') || document.getElementById('products')) {
